...
PointLight& IlluminationBuffer::PointSunRef()
{
	return _sun;
}

void IlluminationBuffer::SetSun(PointLight newSun)
{
	_sun = newSun;
}
...
void IlluminationBuffer::SetSun(float SphereX, float SphereY, float SphereZ)
{
	_sun._lightPos = glm::vec4(SphereX, SphereY, SphereZ, 0.0f);
}
